...
<form action="" method="post" name="postform">
	<div align="center">
	  <p><em>Halaman ini digunakan untuk <strong><a href="?page=backup/index">BACKUP</a></strong> dan <strong><a href="?page=backup/recovery_data">RESTORE</a></strong> semua data yang ada didalam database &quot;<strong>sipadu</strong>&quot;.</em></p>
	  <p><br>
...
if(isset($_POST['backup'])){
	...
	backup_tables("localhost","root","","sipadu",$file);
	
	?>
	<p align="center">&nbsp;</p>
	<p align="center"><a style="cursor:pointer" onclick="location.href='modul/backup/download_backup_data.php?nama_file=<?php echo $file;?>'" title="Download">Backup database telah selesai. <font color="#0066FF">Download file database</font></a>
</p>
	<?php
}else{
	unset($_POST['backup']);
...
function backup_tables($host,$user,$pass,$name,$nama_file,$tables = '*')
{
	...
	$handle = fopen('./modul/backup/backup/'.$nama_file,'w+');
