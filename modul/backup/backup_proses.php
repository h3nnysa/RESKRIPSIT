<?php
	...
	// diasumsikan file mysqldump terletak di dalam folder C:\xampp\xampp\mysql\bin
	$command = "C:\xampp\mysql\bin\mysqldump -u".$username." -p".$password." ".$database." ".$listTabel." > ".$database.".sql";
